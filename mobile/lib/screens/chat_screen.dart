...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    _pollingTimer = Timer.periodic(const Duration(seconds: 3), (_) => _fetchChatHistory(silent: true));
  }
  ...
  Widget _buildMessageBubble(ChatMessage msg, int currentUserId) {
            ...
            child: _isLoading
                ...
                : _messages.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, idx) => _buildMessageBubble(_messages[idx], currentUserId),
                      ),
          ),
